...
class ZerodWithdraw {
    ...
    constructor(constructorObj) {
        ...
        this.dbo = null;
        this.db_url = constructorObj.db.db_url;
        this.db_name = constructorObj.db.db_name;
    }
    ...
    findAddress(withdrawObj, collection) {
        return new Promise((resolve, reject) => {
            this.dbo.collection(collection).findOne({"address": withdrawObj["dest_address"]}, (err, result) => {
                if (err) reject(err);
                if(result == null){
                    withdrawObj["token"] = "eth";
                }
                resolve(withdrawObj);
            });
        });
